...
(function (global, factory) {
  ...
  var config = ({
     ...
     */
    isReservedTag: no, // no是一个返回false的函数
  ...
  function normalizeInject (options, vm) {
    ...
    if (!inject) { return }
    var normalized = options.inject = {}; // 把options.inject重置为{}，最终{ localKey: { from: provideObjKey } }
  ...
  function initMixin (Vue) {
    Vue.prototype._init = function (options) { // vm._init
      var vm = this;
      // a uid
      vm._uid = uid$2++;
